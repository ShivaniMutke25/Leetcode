/**
 * Sliding Window with HashMap Approach - Minimum Window Substring (OPTIMAL)
 * 
 * Logic:
 * - Use sliding window with two pointers: left and right
 * - Maintain frequency counts for current window and t
...
- Contract while valid ensures minimum window
- Each character processed at most twice (entering and leaving window)
- HashMap handles any character set
